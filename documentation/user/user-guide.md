...
- Verify paths in `config/config.ini` are correct
...
# Search for errors
grep ERROR monitoring/logs/librarian.log

# View processing statistics
grep "Processing complete" monitoring/logs/librarian.log
```
...
### Documentation
- **Developer Guide**: `documentation/developer/developer-guide.md` for technical details
- **Architecture Guide**: `documentation/architecture/ENTERPRISE_ARCHITECTURE.md` for system design
- **API Reference**: `documentation/developer/API_REFERENCE.md` for integration detailstures
