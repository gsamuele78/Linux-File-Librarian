...
from .enterprise_error_handling import with_error_handling, EnterpriseException
...
from .enhanced_copy_utils import copy_file_with_enhancements
...
class EnterpriseFileProcessor:
    ...
    def _copy_file(self, file_info: Dict, destination_root: Path) -> Optional[Dict]:
        ...
        try:
            from .enhanced_copy_utils import create_enhanced_destination_path
