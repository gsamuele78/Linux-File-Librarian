...
if [[ ! -f "${PROJECT_ROOT}/src/services/build_knowledgebase.py" ]]; then
  echo "[ERROR] src/services/build_knowledgebase.py not found."
  exit 1
fi
...
if ! PYTHONPATH="${PROJECT_ROOT}" python3 src/services/build_knowledgebase.py; then
